...
| 目录 | 板型 | 屏 | 输入 |
|------|------|-----|------|
| `c6_lcd_13/` | [ESP32-C6-LCD-1.3](https://docs.waveshare.com/ESP32-C6-LCD-1.3) | 240×240 ST7789V2 SPI | BOOT（GPIO0） |
...
ST7789 刷屏、CST816T / QMI8658 驱动为 **TODO 占位**，结构已就绪，后续可对接 Waveshare Arduino 示例或 Arduino_GFX。
